...
//	Ptr<DescriptorMatcher> descriptor_matcher = DescriptorMatcher::create("FlannBased");//创建特征匹配器  
	...
	//读入图像  
	Mat img1 = imread("../TestImage/1-1.JPG");
	Mat img2 = imread("../TestImage/1-2.JPG");
	//针对图像进行ROI选取
   ...
   vector<DMatch> m_InlierMatches;//匹配对
	...
	//double aa1 = 0.000343659;
	//double aa2 = 2.10398e-006;
	//double aa3 = -0.999948;
	//double bb1 = -1.34819e-007;
	//double bb2 = 0.000342671;
	//double bb3 = 0.0101493;
	//double cc1 = 1.35985e-009;
	//double cc2 = -1.67952E-10;
	//double cc3 = 0.000337329;
